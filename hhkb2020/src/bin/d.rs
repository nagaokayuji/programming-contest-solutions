...
fn solve(n: i64, a: i64, b: i64) {
    ...
    let b: Mint = b.into();
    let n: Mint = n.into();
    let xa: Mint = n - a + Mint::new(1);
    let xb: Mint = n - b + Mint::new(1);
    let x4 = (n - a - b + Mint::new(2)) * (n - a - b + Mint::new(1)) / Mint::new(2);
    let x3 = x4 * Mint::new(2);
    let x2 = (n - a + Mint::new(1)) * (n - b + Mint::new(1)) - x3;
    let x1 = x2 * x2;
    let ans = xa * xa * xb * xb - x1;
    println!("{}", ans);
}
